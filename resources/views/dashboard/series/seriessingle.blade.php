		...
		<div class="row ipad-width2">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="movie-img sticky-sb">
					<img src="{{ url('/') }}/Dashboard/images/uploads/series-img.jpg" alt="">
					<div class="movie-btn">	
						    ...
						    <div class="tab-content">
						            ...
						            <div class="row">
						            	<div class="col-md-8 col-sm-12 col-xs-12">
											...
											<div class="mvcast-item">											
												<div class="cast-it">
													<div class="cast-left series-it">
														<img src="{{ url('/') }}/Dashboard/images/uploads/season.jpg" alt="">
														<div>
															<a href="#">Season 10</a>
															<p>21 Episodes</p>
											...
											<div class="mvsingle-item ov-item">
												<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image41.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image4.jpg" alt=""></a>
												<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image51.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image5.jpg" alt=""></a>
												<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image61.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image6.jpg" alt=""></a>
												<div class="vd-it">
													<img class="vd-img" src="{{ url('/') }}/Dashboard/images/uploads/image7.jpg" alt="">
													<a class="fancybox-media hvr-grow" href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{ url('/') }}/Dashboard/images/uploads/play-vd.png" alt=""></a>
												</div>
											</div>
											<div class="title-hd-sm">
												<h4>cast</h4>
											...
											<div class="mvcast-item">											
												<div class="cast-it">
													<div class="cast-left">
														<img src="{{ url('/') }}/Dashboard/images/uploads/cast1.jpg" alt="">
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="{{ url('/') }}/Dashboard/images/uploads/cast2.jpg" alt="">
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="{{ url('/') }}/Dashboard/images/uploads/cast3.jpg" alt="">
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="{{ url('/') }}/Dashboard/images/uploads/cast4.jpg" alt="">
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="{{ url('/') }}/Dashboard/images/uploads/cast5.jpg" alt="">
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="{{ url('/') }}/Dashboard/images/uploads/cast6.jpg" alt="">
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="{{ url('/') }}/Dashboard/images/uploads/cast7.jpg" alt="">
												...
												<div class="cast-it">
													<div class="cast-left">
														<img src="{{ url('/') }}/Dashboard/images/uploads/cast9.jpg" alt="">
						        ...
						        <div id="reviews" class="tab review">
						           <div class="row">
										...
										<div class="mv-user-review-item">
											<div class="user-infor">
												<img src="{{ url('/') }}/Dashboard/images/uploads/userava2.jpg" alt="">
												<div>
										...
										<div class="mv-user-review-item">
											<div class="user-infor">
												<img src="{{ url('/') }}/Dashboard/images/uploads/userava3.jpg" alt="">
												<div>
										...
										<div class="mv-user-review-item ">
											<div class="user-infor">
												<img src="{{ url('/') }}/Dashboard/images/uploads/userava4.jpg" alt="">
												<div>
										...
										<div class="mv-user-review-item last">
											<div class="user-infor">
												<img src="{{ url('/') }}/Dashboard/images/uploads/userava5.jpg" alt="">
												<div>
						        ...
						        <div id="cast" class="tab">
						        	...
						        	<div class="row">
										...
										<div class="mvsingle-item media-item">
											<div class="vd-item">
												<div class="vd-it">
													<img class="vd-img" src="{{ url('/') }}/Dashboard/images/uploads/vd-item1.jpg" alt="">
													<a class="fancybox-media hvr-grow"  href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{ url('/') }}/Dashboard/images/uploads/play-vd.png" alt=""></a>
												</div>
												<div class="vd-infor">
											...
											<div class="vd-item">
												<div class="vd-it">
													<img class="vd-img" src="{{ url('/') }}/Dashboard/images/uploads/vd-item2.jpg" alt="">
													<a class="fancybox-media hvr-grow" href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{ url('/') }}/Dashboard/images/uploads/play-vd.png" alt=""></a>
												</div>
												<div class="vd-infor">
											...
											<div class="vd-item">
												<div class="vd-it">
													<img class="vd-img" src="{{ url('/') }}/Dashboard/images/uploads/vd-item3.jpg" alt="">
													<a class="fancybox-media hvr-grow" href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{ url('/') }}/Dashboard/images/uploads/play-vd.png" alt=""></a>
												</div>
												<div class="vd-infor">
											...
											<div class="vd-item">
												<div class="vd-it">
													<img class="vd-img" src="{{ url('/') }}/Dashboard/images/uploads/vd-item4.jpg" alt="">
													<a class="fancybox-media hvr-grow" href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{ url('/') }}/Dashboard/images/uploads/play-vd.png" alt=""></a>
												</div>
												<div class="vd-infor">
										...
										<div class="mvsingle-item">
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image11.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image1.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image21.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image2.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image31.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image3.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image41.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image4.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image51.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image5.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image61.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image6.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image71.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image7.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image81.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image8.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image91.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image9.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image101.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image10.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image111.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image1-1.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image121.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image12.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image131.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image13.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image141.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image14.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image151.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image15.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image161.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image16.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image171.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image17.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image181.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image18.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image191.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image19.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image201.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image20.jpg" alt=""></a>
											<a class="img-lightbox"  data-fancybox-group="gallery" href="{{ url('/') }}/Dashboard/images/uploads/image211.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image2-1.jpg" alt=""></a>
										</div>
						        	</div>
					       	 	</div>
					       	 	...
					       	 	<div id="moviesrelated" class="tab">
										...
										<div class="movie-item-style-2">
											<img src="{{ url('/') }}/Dashboard/images/uploads/mv1.jpg" alt="">
										...
										<div class="movie-item-style-2">
											<img src="{{ url('/') }}/Dashboard/images/uploads/mv2.jpg" alt="">
											<div class="mv-item-infor">
										...
										<div class="movie-item-style-2">
											<img src="{{ url('/') }}/Dashboard/images/uploads/mv3.jpg" alt="">
											<div class="mv-item-infor">
										...
										<div class="movie-item-style-2">
											<img src="{{ url('/') }}/Dashboard/images/uploads/mv4.jpg" alt="">
											<div class="mv-item-infor">
										...
										<div class="movie-item-style-2">
											<img src="{{ url('/') }}/Dashboard/images/uploads/mv5.jpg" alt="">
											<div class="mv-item-infor">
