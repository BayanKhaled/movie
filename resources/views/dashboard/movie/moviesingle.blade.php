		...
		<div class="row ipad-width2">
			<div class="col-md-4 col-sm-12 col-xs-12">
				<div class="movie-img sticky-sb">
					<img src="{{ url('/') }}/Dashboard/images/uploads/movie-single.jpg" alt="">
					<div class="movie-btn">	
						            ...
						            <div class="row">
						            	<div class="col-md-8 col-sm-12 col-xs-12">
											...
											<div class="mvsingle-item ov-item">
												...
												<div class="vd-it">
													<img class="vd-img" src="{{ url('/') }}/Dashboard/images/uploads/image4.jpg" alt="">
						           ...
						           <div class="row">
										...
										<div class="mv-user-review-item">
											<div class="user-infor">
												<img src="{{ url('/') }}/Dashboard/images/uploads/userava1.jpg" alt="">
												<div>
													<h3>Best Marvel movie in my opinion</h3>
													<div class="no-star">
														<i class="ion-android-star"></i>
						        ...
						        <div id="cast" class="tab">
						        	...
						        	<div class="row">
										...
										<div class="mvsingle-item">
											...
											<a class="img-lightbox"  data-fancybox-group="gallery" href="images/uploads/image81.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image8.jpg" alt=""></a>
											...
											<a class="img-lightbox"  data-fancybox-group="gallery" href="images/uploads/image141.jpg" ><img src="{{ url('/') }}/Dashboard/images/uploads/image14.jpg" alt=""></a>
