		...
		<div class="row ipad-width2">
			<div class="col-md-9 col-sm-12 col-xs-12">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="ceb-item-style-2">
							<img src="{{ url('/') }}/Dashboard/images/uploads/ceb21.jpg" alt="">
							<div class="ceb-infor">
					...
					<div class="col-md-4">
						<div class="ceb-item-style-2">
							<img src="{{ url('/') }}/Dashboard/images/uploads/ceb22.jpg" alt="">
							<div class="ceb-infor">
					...
					<div class="col-md-4">
						<div class="ceb-item-style-2">
							<img src="{{ url('/') }}/Dashboard/images/uploads/ceb23.jpg" alt="">
							<div class="ceb-infor">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="ceb-item-style-2">
							<img src="{{ url('/') }}/Dashboard/images/uploads/ceb24.jpg" alt="">
							<div class="ceb-infor">
					...
					<div class="col-md-4">
						<div class="ceb-item-style-2">
							<img src="{{ url('/') }}/Dashboard/images/uploads/ceb25.jpg" alt="">
							<div class="ceb-infor">
					...
					<div class="col-md-4">
						<div class="ceb-item-style-2">
							<img src="{{ url('/') }}/Dashboard/images/uploads/ceb26.jpg" alt="">
							<div class="ceb-infor">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="ceb-item-style-2">
							<img src="{{ url('/') }}/Dashboard/images/uploads/ceb27.jpg" alt="">
							<div class="ceb-infor">
								<h2><a href="celebritysingle.html">Robert De Niro</a></h2>
								<span>actor, uk</span>
							</div>
					...
					<div class="col-md-4">
						<div class="ceb-item-style-2">
							<img src="{{ url('/') }}/Dashboard/images/uploads/ceb28.jpg" alt="">
							<div class="ceb-infor">
								<h2><a href="celebritysingle.html">Kamal Haasan</a></h2>
								<span>actress, usa</span>
							</div>
					...
					<div class="col-md-4">
						<div class="ceb-item-style-2">
							<img src="{{ url('/') }}/Dashboard/images/uploads/ceb29.jpg" alt="">
							<div class="ceb-infor">
								<h2><a href="celebritysingle.html">Anthony Hopkins</a></h2>
								<span>actress, France</span>
							</div>
