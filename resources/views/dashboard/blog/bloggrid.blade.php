		...
		<div class="row">
			<div class="col-md-9 col-sm-12 col-xs-12">
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.html"><img src="{{ url('/') }}/Dashboard/images/uploads/blogv21.jpg" alt=""></a>
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.html"><img src="{{ url('/') }}/Dashboard/images/uploads/blogv22.jpg" alt=""></a>
							<div class="blog-it-infor">
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.html"><img src="{{ url('/') }}/Dashboard/images/uploads/blogv23.jpg" alt=""></a>
							<div class="blog-it-infor">
				...
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.html"><img src="{{ url('/') }}/Dashboard/images/uploads/blogv24.jpg" alt=""></a>
							<div class="blog-it-infor">
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.html"><img src="{{ url('/') }}/Dashboard/images/uploads/blogv29.jpg" alt=""></a>
							<div class="blog-it-infor">
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.html"><img src="{{ url('/') }}/Dashboard/images/uploads/blog29.jpg" alt=""></a>
							<div class="blog-it-infor">
				...
				<div class="row">
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.html"><img src="{{ url('/') }}/Dashboard/images/uploads/blog27.jpg" alt=""></a>
							<div class="blog-it-infor">
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.html"><img src="{{ url('/') }}/Dashboard/images/uploads/blog26.jpg" alt=""></a>
							<div class="blog-it-infor">
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="blog-item-style-2">
							<a href="blogdetail.html"><img src="{{ url('/') }}/Dashboard/images/uploads/blogv25.jpg" alt=""></a>
							<div class="blog-it-infor">
