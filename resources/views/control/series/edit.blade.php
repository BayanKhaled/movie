...
<div class="card text-left">
    ...
    <div class="card-body">
		...
		{{ Form::open(array('url' =>  '/control/series/'.$series->id, 'method' => 'put', 'files' => true)) }}
		    ...
		    <div class="col-sm-10">
				{{ Form::select('genres[]', App\Models\Genres::pluck('name', 'id'),$genres,['multiple'=>'multiple','id'=>'sports','class' => 'select2 select2-hidden-accessible','data-placeholder' => 'Select a State','style' => 'width: 100%;', 'data-select2-id' => '8', 'aria-hidden' => 'true'])  }}
		    </div>
			</div>
		    ...
		    <div class="col-sm-10">
				{{ Form::select('tags[]', App\Models\Tags::pluck('name', 'id'),$tags,['multiple'=>'multiple','id'=>'sports','class' => 'select2 select2-hidden-accessible','data-placeholder' => 'Select a State','style' => 'width: 100%;', 'data-select2-id' => '9', 'aria-hidden' => 'true'])  }}
		    </div>
			</div>
