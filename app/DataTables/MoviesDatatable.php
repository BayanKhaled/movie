...
class MoviesDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', '
                <a class="btn btn-default btn-outline-primary" href="movies/{{ $id }}/edit">Edit</a>
                <form action="movies/{{ $id }}" method="POST" onsubmit="return confirm(\'Are You sure?\');" style="display: inline-block;">
    ...
    {
        return $this->builder()
                    ->setTableId('moviesdatatables-table')
