...
class SeasonsDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', '
                <a class="btn btn-default btn-outline-primary" href="seasons/{{ $id }}/edit">Edit</a>
                <form action="seasons/{{ $id }}" method="POST" onsubmit="return confirm(\'Are You sure?\');" style="display: inline-block;">
