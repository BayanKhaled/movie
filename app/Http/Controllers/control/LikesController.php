...
class LikesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        /*$like = \App\models\Likes::find($like->id);

        $user = \App\models\Users::find($data['user_id']);
        $like->user()->attach($user);

        $movie = \App\models\Movies::find($data['movie_id']);
        $like->movie()->attach($movie);

        $episode = \App\models\Episodes::find($data['episode_id']);
        $like->episode()->attach($episode);*/
    ...
    public function edit($id)
    {
        ...
        $like = \App\Models\Movies::find($id);
